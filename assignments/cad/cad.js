...
window.onload = function init() {
  ...
  document.getElementById("colorSelector").onchange = function(event) {
    var selectedValue = this.value;
    var colorPlate = document.getElementById("colorPlate");

    cIndex = selectedValue;

    switch (selectedValue) {
      case '0':
        colorPlate.style.backgroundColor = 'black';
        break;
      case '1':
        colorPlate.style.backgroundColor = 'red';
        break;
      case '2':
        colorPlate.style.backgroundColor = 'yellow';
        break;
      case '3':
        colorPlate.style.backgroundColor = 'green';
        break;
      case '4':
        colorPlate.style.backgroundColor = 'blue';
        break;
      case '5':
        colorPlate.style.backgroundColor = 'magenta';
        break;
      case '6':
        colorPlate.style.backgroundColor = 'cyan';
        break;
    }
  };
